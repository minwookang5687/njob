                            ...
                            <td>
                                ...
                                <select name='entry.302176945' id='license' class="form-control" placeholder="현재 조건">
                                    ...
                                    <option value="자격증 선택" selected disabled>자격증 선택</option>
                                        ...
                                        <option value="타로심리상담사">타로심리상담사</option>
...
<INPUT type=hidden name=item_no value="837">
<input type=hidden name="refe" value="/form_make/form.php?it=837&pt=flosmarketing">
<input type="hidden" name="sub_url" id="url" value="https://marketclub.cafe24.com/form_make/form.php?it=837&pt=flosmarketing">
